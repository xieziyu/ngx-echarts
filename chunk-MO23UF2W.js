import{De as S,Q,q as A,v as C,ze as H}from"./chunk-XO43HBH7.js";import{a as x,c as O}from"./chunk-FOI7OYIU.js";import{$ as P,Aa as L,B as z,Ga as F,Ha as G,I as s,Ia as Z,J as a,Ja as W,K as r,Ka as U,L as m,La as j,M as w,Na as v,O as l,Oa as V,oa as M,qa as N,r as f,va as R,wa as k,x as p,y as d,z as y,za as B}from"./chunk-YHMR6KXT.js";var X=`<!-- DEMO START -->
<div nz-row>
...
`;var D=(()=>{let t=class t{constructor(){this.html=X,this.component=Y,this.options={color:["#3398DB"],tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",data:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],axisTick:{alignWithLabel:!0}}],yAxis:[{type:"value"}],series:[{name:"Counters",type:"bar",barWidth:"60%",data:[10,52,200,334,390,330,220]}]}}ngAfterViewInit(){setTimeout(()=>{let o=document.getElementById("chart1"),n=document.getElementById("chart2"),i=S(o),g=S(n);H([i,g])})}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=d({type:t,selectors:[["app-connect-charts"]],decls:10,vars:4,consts:[["nz-row",""],["nz-col","","nzSpan","12"],["id","chart1","echarts","","theme","macarons",1,"demo-chart",3,"options"],["id","chart2","echarts","","theme","macarons",1,"demo-chart",3,"options"],[3,"html","component"]],template:function(n,i){n&1&&(a(0,"div",0)(1,"div",1)(2,"h5"),l(3,"id=chart1"),r(),m(4,"div",2),r(),a(5,"div",1)(6,"h5"),l(7,"id=chart2"),r(),m(8,"div",3),r()(),m(9,"app-code-block",4)),n&2&&(p(4),s("options",i.options),p(4),s("options",i.options),p(),s("html",i.html)("component",i.component))},dependencies:[R,k,x,v],encapsulation:2});let e=t;return e})();Q();var $=`<!-- DEMO START -->
