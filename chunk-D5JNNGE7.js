import{a as g,c as ue,h as X,i as ot}from"./chunk-63UHJ6OY.js";import{$ as le,B as L,D as q,E as p,F as h,Fa as fe,G as S,H as G,Ha as U,I as F,Ia as ge,J as v,Ja as Ce,K as ee,Ka as ve,La as be,M as te,Ma as ye,N as oe,Na as Te,O as ne,Oa as Ee,P as ie,Pa as De,Q as ae,Qa as ze,R as l,Ra as xe,S as s,T as c,U as m,V as re,Va as Se,W as se,Wa as _e,X as ce,Xa as T,Y as u,Ya as E,Z as W,Za as Me,_ as me,_a as ke,a as D,aa as pe,b as $,ba as f,fb as Ne,ga as de,gb as Oe,hb as Ie,ib as we,j as z,jb as Be,lb as C,ma as P,mb as Re,n as H,o as V,qa as he,r as Z,s as x,u as y,w as K,x as Y,y as J,z as Q}from"./chunk-GKCWJT7B.js";var Ae=`<!-- DEMO START -->
...
`;var k=(()=>{let o=class o{constructor(){this.html=We,this.component=Pe,this.initOpts={renderer:"svg",width:300,height:300},this.options={color:["#3398DB"],tooltip:{trigger:"axis",axisPointer:{type:"shadow"}},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",data:["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],axisTick:{alignWithLabel:!0}}],yAxis:[{type:"value"}],series:[{name:"Counters",type:"bar",barWidth:"60%",data:[10,52,200,334,390,330,220]}]}}};o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=h({type:o,selectors:[["app-basic-init-opts"]],decls:2,vars:4,consts:[[3,"initOpts","options"],[3,"html","component"]],template:function(t,i){t&1&&m(0,"echarts",0)(1,"app-code-block",1),t&2&&(l("initOpts",i.initOpts)("options",i.options),p(),l("html",i.html)("component",i.component))},dependencies:[g,C],encapsulation:2});let e=o;return e})();var mt=(e,o)=>({$implicit:e,data:o});function lt(e,o){e&1&&m(0,"nz-icon",3)}function pt(e,o){e&1&&m(0,"nz-icon",4)}function dt(e,o){e&1&&m(0,"nz-icon",5)}function ht(e,o){e&1&&m(0,"nz-icon",6)}function ut(e,o){e&1&&m(0,"nz-icon",7)}function ft(e,o){if(e&1&&(re(0),m(1,"span",9),se()),e&2){let a=W();p(),l("innerHTML",a.instance.content,q)}}function gt(e,o){if(e&1){let a=ce();s(0,"nz-message",2),u("destroyed",function(t){K(a);let i=W();return Y(i.remove(t.id,t.userAction))}),c()}if(e&2){let a=o.$implicit;l("instance",a)}}var Ct=0,j=class{container;nzSingletonService=y(ke);overlay=y(ye);injector=y(J);remove(o){this.container&&(o?this.container.remove(o):this.container.removeAll())}getInstanceId(){return`${this.componentPrefix}-${Ct++}`}withContainer(o){let a=this.nzSingletonService.getSingletonWithKey(this.componentPrefix);if(a)return a;let n=this.overlay.create({hasBackdrop:!1,scrollStrategy:this.overlay.scrollStrategies.noop(),positionStrategy:this.overlay.position().global()}),t=new be(o,null,this.injector),i=n.attach(t),r=n.hostElement;return r.style.zIndex="1010",a||(this.container=a=i.instance,this.nzSingletonService.registerSingletonWithKey(this.componentPrefix,a),this.container.afterAllInstancesRemoved.subscribe(()=>{this.container=void 0,this.nzSingletonService.unregisterSingletonWithKey(this.componentPrefix),n.dispose()})),a}},vt=(()=>{class e{config;instances=[];_afterAllInstancesRemoved=new z;afterAllInstancesRemoved=this._afterAllInstancesRemoved.asObservable();cdr=y(P);nzConfigService=y(Te);constructor(){this.subscribeConfigChange()}create(a){let n=this.onCreate(a);return this.instances.length>=this.config.nzMaxStack&&(this.instances=this.instances.slice(1)),this.instances=[...this.instances,n],this.readyInstances(),n}remove(a,n=!1){this.instances.map((t,i)=>({index:i,instance:t})).filter(({instance:t})=>t.messageId===a).forEach(({index:t,instance:i})=>{this.instances.splice(t,1),this.instances=[...this.instances],this.onRemove(i,n),this.readyInstances()}),this.instances.length||this.onAllInstancesRemoved()}removeAll(){this.instances.forEach(a=>this.onRemove(a,!1)),this.instances=[],this.readyInstances(),this.onAllInstancesRemoved()}onCreate(a){return a.options=this.mergeOptions(a.options),a.onClose=new z,a}onRemove(a,n){a.onClose.next(n),a.onClose.complete()}onAllInstancesRemoved(){this._afterAllInstancesRemoved.next(),this._afterAllInstancesRemoved.complete()}readyInstances(){this.cdr.detectChanges()}mergeOptions(a){let{nzDuration:n,nzAnimate:t,nzPauseOnHover:i}=this.config;return D({nzDuration:n,nzAnimate:t,nzPauseOnHover:i},a)}static \u0275fac=function(n){return new(n||e)};static \u0275dir=G({type:e})}return e})(),bt=(()=>{class e{cdr=y(P);destroyRef=y(Q);animationStateChanged=new z;options;autoClose;closeTimer;userAction=!1;eraseTimer;eraseTimingStart;eraseTTL;constructor(){this.destroyRef.onDestroy(()=>{this.autoClose&&this.clearEraseTimeout(),this.animationStateChanged.complete()})}ngOnInit(){this.options=this.instance.options,this.options.nzAnimate&&(this.instance.state="enter",this.animationStateChanged.pipe(H(a=>a.phaseName==="done"&&a.toState==="leave"),V(1)).subscribe(()=>{clearTimeout(this.closeTimer),this.destroyed.next({id:this.instance.messageId,userAction:this.userAction})})),this.autoClose=this.options.nzDuration>0,this.autoClose&&(this.initErase(),this.startEraseTimeout())}onEnter(){this.autoClose&&this.options.nzPauseOnHover&&(this.clearEraseTimeout(),this.updateTTL())}onLeave(){this.autoClose&&this.options.nzPauseOnHover&&this.startEraseTimeout()}destroy(a=!1){this.userAction=a,this.options.nzAnimate?(this.instance.state="leave",this.cdr.detectChanges(),this.closeTimer=setTimeout(()=>{this.closeTimer=void 0,this.destroyed.next({id:this.instance.messageId,userAction:a})},200)):this.destroyed.next({id:this.instance.messageId,userAction:a})}initErase(){this.eraseTTL=this.options.nzDuration,this.eraseTimingStart=Date.now()}updateTTL(){this.autoClose&&(this.eraseTTL-=Date.now()-this.eraseTimingStart)}startEraseTimeout(){this.eraseTTL>0?(this.clearEraseTimeout(),this.eraseTimer=setTimeout(()=>this.destroy(),this.eraseTTL),this.eraseTimingStart=Date.now()):this.destroy()}clearEraseTimeout(){this.eraseTimer!==null&&(clearTimeout(this.eraseTimer),this.eraseTimer=void 0)}static \u0275fac=function(n){return new(n||e)};static \u0275dir=G({type:e})}return e})(),yt=(()=>{class e extends bt{instance;destroyed=new ee;index;static \u0275fac=(()=>{let a;return function(t){return(a||(a=L(e)))(t||e)}})();static \u0275cmp=h({type:e,selectors:[["nz-message"]],inputs:{instance:"instance"},outputs:{destroyed:"destroyed"},exportAs:["nzMessage"],features:[F],decls:9,vars:9,consts:[[1,"ant-message-notice",3,"mouseenter","mouseleave"],[1,"ant-message-notice-content"],[1,"ant-message-custom-content"],["nzType","check-circle"],["nzType","info-circle"],["nzType","exclamation-circle"],["nzType","close-circle"],["nzType","loading"],[4,"nzStringTemplateOutlet","nzStringTemplateOutletContext"],[3,"innerHTML"]],template:function(n,t){if(n&1&&(s(0,"div",0),u("@moveUpMotion.done",function(r){return t.animationStateChanged.next(r)})("mouseenter",function(){return t.onEnter()})("mouseleave",function(){return t.onLeave()}),s(1,"div",1)(2,"div",2),te(3,lt,1,0,"nz-icon",3)(4,pt,1,0,"nz-icon",4)(5,dt,1,0,"nz-icon",5)(6,ht,1,0,"nz-icon",6)(7,ut,1,0,"nz-icon",7),v(8,ft,2,1,"ng-container",8),c()()()),n&2){let i;l("@moveUpMotion",t.instance.state),p(2),pe("ant-message-"+t.instance.type),p(),oe((i=t.instance.type)==="success"?3:i==="info"?4:i==="warning"?5:i==="error"?6:i==="loading"?7:-1),p(5),l("nzStringTemplateOutlet",t.instance.content)("nzStringTemplateOutletContext",de(6,mt,t,t.instance.options==null?null:t.instance.options.nzData))}},dependencies:[xe,ze,ve,Ce],encapsulation:2,data:{animation:[De]},changeDetection:0})}return e})(),N="message",Tt={nzAnimate:!0,nzDuration:3e3,nzMaxStack:7,nzPauseOnHover:!0,nzTop:24,nzDirection:"ltr"},Et=(()=>{class e extends vt{dir=this.nzConfigService.getConfigForComponent(N)?.nzDirection||"ltr";top;constructor(){super(),this.updateConfig()}subscribeConfigChange(){Ee(N,()=>{this.updateConfig(),this.dir=this.nzConfigService.getConfigForComponent(N)?.nzDirection||this.dir})}updateConfig(){this.config=D(D(D({},Tt),this.config),this.nzConfigService.getConfigForComponent(N)),this.top=ge(this.config.nzTop),this.cdr.markForCheck()}static \u0275fac=function(n){return new(n||e)};static \u0275cmp=h({type:e,selectors:[["nz-message-container"]],exportAs:["nzMessageContainer"],features:[F],decls:3,vars:4,consts:[[1,"ant-message"],[3,"instance"],[3,"destroyed","instance"]],template:function(n,t){n&1&&(s(0,"div",0),ie(1,gt,1,1,"nz-message",1,ne),c()),n&2&&(me("top",t.top),le("ant-message-rtl",t.dir==="rtl"),p(),ae(t.instances))},dependencies:[yt],encapsulation:2,changeDetection:0})}return e})(),Ue=(()=>{class e extends j{componentPrefix="message-";success(a,n){return this.createInstance({type:"success",content:a},n)}error(a,n){return this.createInstance({type:"error",content:a},n)}info(a,n){return this.createInstance({type:"info",content:a},n)}warning(a,n){return this.createInstance({type:"warning",content:a},n)}loading(a,n){return this.createInstance({type:"loading",content:a},n)}create(a,n,t){return this.createInstance({type:a,content:n},t)}createInstance(a,n){return this.container=this.withContainer(Et),this.container.create($(D({},a),{createdAt:new Date,messageId:this.getInstanceId(),options:n}))}static \u0275fac=(()=>{let a;return function(t){return(a||(a=L(e)))(t||e)}})();static \u0275prov=Z({token:e,factory:e.\u0275fac,providedIn:"root"})}return e})();var Xe=`<!-- DEMO START -->
<div class="button-groups">
...
`;var R=(()=>{let o=class o{constructor(){this.html=qe,this.component=et,this.oneDay=24*3600*1e3}ngOnInit(){this.data=[],this.now=new Date(1997,9,3),this.value=Math.random()*1e3;for(let n=0;n<1e3;n++)this.data.push(this.randomData());this.options={title:{text:"Dynamic Data + Time Axis"},tooltip:{trigger:"axis",formatter:n=>{n=n[0];let t=new Date(n.name);return t.getDate()+"/"+(t.getMonth()+1)+"/"+t.getFullYear()+" : "+n.value[1]},axisPointer:{animation:!1}},xAxis:{type:"time",splitLine:{show:!1}},yAxis:{type:"value",boundaryGap:[0,"100%"],splitLine:{show:!1}},series:[{name:"Mocking Data",type:"line",showSymbol:!1,data:this.data}]},this.timer=setInterval(()=>{for(let n=0;n<5;n++)this.data.shift(),this.data.push(this.randomData());this.updateOptions={series:[{data:this.data}]}},1e3)}ngOnDestroy(){clearInterval(this.timer)}randomData(){return this.now=new Date(this.now.getTime()+this.oneDay),this.value=this.value+Math.random()*21-10,{name:this.now.toString(),value:[[this.now.getFullYear(),this.now.getMonth()+1,this.now.getDate()].join("/"),Math.round(this.value)]}}};o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=h({type:o,selectors:[["app-basic-update"]],decls:2,vars:4,consts:[["echarts","",1,"demo-chart",3,"options","merge"],[3,"html","component"]],template:function(t,i){t&1&&m(0,"div",0)(1,"app-code-block",1),t&2&&(l("options",i.options)("merge",i.updateOptions),p(),l("html",i.html)("component",i.component))},dependencies:[g,C],encapsulation:2});let e=o;return e})();function Bt(e,o){e&1&&m(0,"app-basic-simple")}function Rt(e,o){e&1&&m(0,"app-basic-dataset")}function At(e,o){e&1&&m(0,"app-basic-events")}function Lt(e,o){e&1&&m(0,"app-basic-themes")}function Gt(e,o){e&1&&m(0,"app-basic-loading")}function Ft(e,o){e&1&&m(0,"app-basic-update")}function Wt(e,o){e&1&&m(0,"app-basic-init-opts")}function Pt(e,o){e&1&&m(0,"app-basic-instance")}var A=(()=>{let o=class o{constructor(){}};o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=h({type:o,selectors:[["app-basic"]],decls:25,vars:1,consts:[["nzTitle","Getting Started"],["nz-page-header-breadcrumb",""],["routerLink","/welcome"],[2,"margin-top","8px",3,"nzTabPosition"],["nzTitle","Simple Chart"],["nz-tab",""],["nzTitle","Dataset"],["nzTitle","Events"],["nzTitle","[theme]"],["nzTitle","[loading]"],["nzTitle","[merge]"],["nzTitle","[initOpts]"],["nzTitle","ECharts Instance"]],template:function(t,i){t&1&&(s(0,"nz-page-header",0)(1,"nz-breadcrumb",1)(2,"nz-breadcrumb-item")(3,"a",2),f(4,"Home"),c()(),s(5,"nz-breadcrumb-item"),f(6,"Getting Started"),c()()(),m(7,"nz-divider"),s(8,"nz-tabs",3)(9,"nz-tab",4),v(10,Bt,1,0,"ng-template",5),c(),s(11,"nz-tab",6),v(12,Rt,1,0,"ng-template",5),c(),s(13,"nz-tab",7),v(14,At,1,0,"ng-template",5),c(),s(15,"nz-tab",8),v(16,Lt,1,0,"ng-template",5),c(),s(17,"nz-tab",9),v(18,Gt,1,0,"ng-template",5),c(),s(19,"nz-tab",10),v(20,Ft,1,0,"ng-template",5),c(),s(21,"nz-tab",11),v(22,Wt,1,0,"ng-template",5),c(),s(23,"nz-tab",12),v(24,Pt,1,0,"ng-template",5),c()()),t&2&&(p(8),l("nzTabPosition","left"))},dependencies:[Oe,_e,Ne,Se,fe,Me,Be,we,Ie,w,_,M,B,I,R,k,O],encapsulation:2});let e=o;return e})();var Ut=[{path:"",redirectTo:"basic-usage",pathMatch:"full"},{path:"basic-usage",component:A}],tt=(()=>{let o=class o{};o.\u0275fac=function(t){return new(t||o)},o.\u0275mod=S({type:o}),o.\u0275inj=x({imports:[U.forChild(Ut),U]});let e=o;return e})();var si=(()=>{let o=class o{};o.\u0275fac=function(t){return new(t||o)},o.\u0275mod=S({type:o}),o.\u0275inj=x({imports:[he,Re,ue,tt,A,w,M,B,I,R,k,O,_]});let e=o;return e})();export{si as DemoBasicModule};
